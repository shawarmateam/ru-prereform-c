...
int main(int argv, char** argc) {
    ...
    replaceWord(str, "мыслимый",      "signed");
    replaceWord(str, "немыслимый",    "unsigned");
    replaceWord(str, "размѣръ",       "sizeof");
    replaceWord(str, "домъ",          "struct");
    replaceWord(str, "пустой",        "void");
